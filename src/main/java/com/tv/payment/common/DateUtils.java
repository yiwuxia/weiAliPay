...
public class DateUtils {
	...
	/**
	 * 给订单id用的日期时间显示格式：yyMMddHHmmssssss
	 */
	public static final String ORDER_DATETIME_FORMAT = "yyMMddHHmmssssss";
	...
	public static Date makeDate(String dateString, String pattern) throws Exception {
		if(StringUtils.isBlank(dateString))
			return null;
		return new SimpleDateFormat(StringUtils.defaultString(pattern, DEFAULT_DATETIME_FORMAT)).parse(dateString);
	}
	...
	public static void main(String[] args) {
		System.out.println(DateUtils.diffDays(getMonthLastDay(), new Date()));
	}
}
